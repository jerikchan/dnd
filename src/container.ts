...
function handleDrop({ element, draggables, layout, getOptions }: ContainerProps) {
  ...
  const dropHandler = (faiDnD.dropHandler || domDropHandler)({ element, draggables, layout, getOptions });
...
const faiDnD: FaiDnDCreator = function (element: HTMLElement, options?: ContainerOptions): FaiDnD {
